...
public enum WakeUpLightDAO
{
	...
	private WakeUpLightDAO()
	{
		...
		List<DeviceActionField> fieldList1 = new ArrayList<DeviceActionField>();
		...
		List<DeviceActionField> fieldList2 = new ArrayList<DeviceActionField>();
		fieldList2.add(new DeviceActionField<Integer>("LightStrength", 230));
		fieldList2.add(new DeviceActionField<String>("Identifier", "Kueche1"));

		List<DeviceActionField> fieldList3 = new ArrayList<DeviceActionField>();
		fieldList2.add(new DeviceActionField<Integer>("LightStrength", 123));
		fieldList2.add(new DeviceActionField<String>("Identifier", "Kueche2"));

		DeviceAction devAct1 = new DeviceAction("WS2801_01", 0, 5, fieldList1);
		DeviceAction devAct2 = new DeviceAction("LIFX01_01", 0, 2, fieldList2);
		DeviceAction devAct3 = new DeviceAction("LIFX01_01", 1, 2, fieldList3);
		...
		Alarm alm1 = new Alarm(LocalTime.of(8, 0), 0, "1110000", true, 0);
		Alarm alm2 = new Alarm(LocalTime.of(10, 0), 0, "0000011", true, 1);
