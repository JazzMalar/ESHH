...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Device` (`idDevice`, `name`, `stringId`, `gpio`) VALUES (0, 'LEDStrip', 'WS2801_01', 1);
INSERT INTO `mydb`.`Device` (`idDevice`, `name`, `stringId`, `gpio`) VALUES (1, 'Lifx Birne', 'LIFX_01', 0);
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`DeviceAction_WS2801_01` (`idDeviceAction`, `LuxStart`, `LuxEnd`, `ColorStart`, `ColorEnd`, `NumLeds`) VALUES (0, 0, 254, 000, fff, 25);
INSERT INTO `mydb`.`DeviceAction_WS2801_01` (`idDeviceAction`, `LuxStart`, `LuxEnd`, `ColorStart`, `ColorEnd`, `NumLeds`) VALUES (1, 50, 120, fefefe, efefef, 25);
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`DeviceAction_LIFX_01` (`idDeviceAction`, `lifxId`, `lightIntesity`) VALUES (0, 'a223d', 254);
INSERT INTO `mydb`.`DeviceAction_LIFX_01` (`idDeviceAction`, `lifxId`, `lightIntesity`) VALUES (1, 'aofo', 10);
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`ActionGroupMember` (`idActionGroupMember`, `idGroup`, `idDevice`, `idAction`, `Offset`) VALUES (0, 0, 0, 0, 0);
INSERT INTO `mydb`.`ActionGroupMember` (`idActionGroupMember`, `idGroup`, `idDevice`, `idAction`, `Offset`) VALUES (1, 0, 1, 1, 10);
INSERT INTO `mydb`.`ActionGroupMember` (`idActionGroupMember`, `idGroup`, `idDevice`, `idAction`, `Offset`) VALUES (2, 1, 0, 1, 20);
INSERT INTO `mydb`.`ActionGroupMember` (`idActionGroupMember`, `idGroup`, `idDevice`, `idAction`, `Offset`) VALUES (3, 1, 1, 0, 10);
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Alarm` (`idTask`, `startTime`, `repeatPattern`, `active`, `idActionGroup`) VALUES (0, '08:00:00', '1111100', 1, 0);
INSERT INTO `mydb`.`Alarm` (`idTask`, `startTime`, `repeatPattern`, `active`, `idActionGroup`) VALUES (1, '10:00:00', '0000011', 1, 1);
